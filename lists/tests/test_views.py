...
class ListViewTest(TestCase):
    ...
    def test_for_invalid_input_show_errors_on_page(self):
    ...
    def test_validate_if_empty_text_can_save(self):
        ...
        list_ = List.objects.create()
        self.client.post(f'/lists/{list_.id}/', data={'text': '1 - A new item for an existing list'})
        self.client.post(f'/lists/{list_.id}/', data={'text': '2 - A new item for an existing list'})
